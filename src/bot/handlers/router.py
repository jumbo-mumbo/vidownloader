...
async def main_handler(message: types.Message):
    if message.text.startswith("/"):
        ...
        bot_message = await message.answer("*Pulling video data...*", parse_mode="Markdown")
...
async def download_video_callback(
    ...
    bot_message = await query.message.answer("*Downloading video, please wait...*", parse_mode="Markdown")
